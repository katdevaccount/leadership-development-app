...
interface CompanyInfoClientProps {
  copy: CompanyInfoCopy
}

export function CompanyInfoClient({ copy }: CompanyInfoClientProps) {
      ...
      >
        <div className="flex flex-col items-center text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-gray-700 mb-2 font-mono">
            {themeNames.length === 1 ? copy.titleSingle : copy.titleMultiple}
          </h1>
          <p className="text-gray-500 font-mono">
            {themeNames.length === 1
              ? copy.subtitleSingle
              : copy.subtitleMultiple
            }
          </p>
        </div>
