...
interface JobRoleClientProps {
  copy: JobRoleCopy
}

export function JobRoleClient({ copy }: JobRoleClientProps) {
      ...
      >
        ...
        >
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h2 className="text-lg font-semibold text-gray-700 font-mono">{copy.purposeTitle}</h2>
              <p className="text-sm text-gray-500 font-mono">{copy.purposeSubtitle}</p>
            </div>
          </div>
          <textarea
        ...
        >
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h2 className="text-lg font-semibold text-gray-700 font-mono">{copy.themesTitle}</h2>
              <p className="text-sm text-gray-500 font-mono">{copy.themesSubtitle}</p>
            </div>
          </div>
            ...
            {themes.map((theme, index) => (
              <div key={index} className="flex items-center gap-2">
                ...
                <input
                  ...
                  placeholder={index === 0 ? copy.themePlaceholder : copy.themeSecondaryPlaceholder}
          ...
          {themes[0] === '' && (
            <div className="mt-4">
              <p className="text-xs text-gray-400 font-mono mb-2">{copy.suggestionsLabel}</p>
