...
export function OnboardingClient({ copy }: OnboardingClientProps) {
  ...
  const displayTitle = copy.title.includes('{username}')
    ? copy.title.replace('{username}', user.email.split("@")[0])
    : `${copy.title.replace('!', '')}, ${user.email.split("@")[0]}!`
    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
      ...
      >
        <div className="flex flex-col items-center text-center">
          ...
          <h1 className="text-2xl font-bold text-gray-700 mb-2 font-mono">{displayTitle}</h1>
          ...
          <div className="w-full space-y-4 mb-8">
            ...
            >
              ...
              <span className="text-gray-400 font-mono">{copy.step1}</span>
            </motion.div>
            ...
            >
              <div className="w-3 h-3 bg-gray-300 rounded-full shadow-[inset_2px_2px_4px_#d1d9e6,inset_-2px_-2px_4px_#ffffff]"></div>
              <span className="text-gray-400 font-mono">{copy.step2}</span>
            </motion.div>
            ...
            >
              <div className="w-3 h-3 bg-gray-300 rounded-full shadow-[inset_2px_2px_4px_#d1d9e6,inset_-2px_-2px_4px_#ffffff]"></div>
              <span className="text-gray-400 font-mono">{copy.step3}</span>
            </motion.div>
          </div>
