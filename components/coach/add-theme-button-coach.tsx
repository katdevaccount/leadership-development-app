...
import { createClientTheme } from '@/lib/actions/coach'

interface AddThemeButtonCoachProps {
  clientId: string
  currentThemeCount: number
}

export function AddThemeButtonCoach({ clientId, currentThemeCount }: AddThemeButtonCoachProps) {
  ...
  const handleAdd = () => {
    ...
    startTransition(async () => {
      const result = await createClientTheme(clientId, themeName.trim())
